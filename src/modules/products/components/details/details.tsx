    ...
    return (
        <article className="rounded-lg bg-light">
                ...
                <div className="flex flex-col items-start p-5 pt-10 md:w-1/2 lg:p-14 xl:p-16">
                        ...
                        {description && (
                            <div className="mt-3 text-sm leading-7 text-body md:mt-4">
                                {typeof description == "string" ? (
                                    ...
                                    DescriptionTable({
                                        description,
                                        specifiedKeys: ["short_description"]
                                    })
                                )}
                            </div>
                        )}
                    ...
                    {shop?.name && (
                        <div className="mt-2 flex items-center">
                            ...
                            <button
                                onClick={() =>
                                    navigate(Routes.shop(shop?.slug))
                                }
            ...
            >
                ...
                {description && !(description instanceof Object) ? (
                    <p className="text-sm text-body">{parse(description)}</p>
                ) : description && description != null ? (
                    DescriptionTable({ description } as any)
                ) : (
                    ""
                )}
            </Element>
